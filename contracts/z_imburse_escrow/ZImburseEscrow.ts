...
EntitlementReceiptNote: {
  ...
  public declare methods: {
    ...
    /** nullify_recurring_entitlement(to: struct, verifier_id: integer) */
    nullify_recurring_entitlement: ((to: AztecAddressLike, verifier_id: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
