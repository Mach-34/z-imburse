...
EntitlementNote: {
  ...
  public declare methods: {
    ...
    /** united_test(header: array, header_length: integer, pubkey_modulus: array, pubkey_redc: array, signature: array, dkim_header_sequence_index: integer, dkim_header_sequence_length: integer, body_hash_index: integer, from_index: integer, subject_index: integer, partial_body_hash: array, body_amount_selection: array, partial_body_hash_date: array, body_date_selection: array) */
    united_test: ((header: (bigint | number)[], header_length: (bigint | number), pubkey_modulus: FieldLike[], pubkey_redc: FieldLike[], signature: FieldLike[], dkim_header_sequence_index: (bigint | number), dkim_header_sequence_length: (bigint | number), body_hash_index: (bigint | number), from_index: (bigint | number), subject_index: (bigint | number), partial_body_hash: (bigint | number)[], body_amount_selection: (bigint | number)[], partial_body_hash_date: (bigint | number)[], body_date_selection: (bigint | number)[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    public static get events(): { RecurringReimbursementClaimed: {decode: (payload: L1EventPayload | UnencryptedL2Log | undefined) => RecurringReimbursementClaimed | undefined, eventSelector: EventSelector, fieldNames: string[] }, SpotReimbursementClaimed: {decode: (payload: L1EventPayload | UnencryptedL2Log | undefined) => SpotReimbursementClaimed | undefined, eventSelector: EventSelector, fieldNames: string[] }, EntitlementNullified: {decode: (payload: L1EventPayload | UnencryptedL2Log | undefined) => EntitlementNullified | undefined, eventSelector: EventSelector, fieldNames: string[] } } {
    return {
